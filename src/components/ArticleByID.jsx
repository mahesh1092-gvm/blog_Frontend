    ...
    const getArticle = async () => {
      ...
      try {
        const res = await axios.get(
          `https://blog-backend-rqmb.onrender.com/user-api/article/${id}`,
          {
  ...
  const toggleArticleStatus = async () => {
    ...
    try {
      const res = await axios.patch(
        "https://blog-backend-rqmb.onrender.com/author-api/articles",
  ...
  const addComment = async (formData) => {
    ...
    try {
      const res = await axios.put(
        "https://blog-backend-rqmb.onrender.com/user-api/articles", //
        commentObj,
        {
          withCredentials: true,
          headers: {
